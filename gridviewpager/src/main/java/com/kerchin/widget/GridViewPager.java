...
public class GridViewPager extends RelativeLayout {
    ...
    public GridViewPager init(List<Model> list) {
        ...
        for (int i = 0; i < pageCount; i++) {
            ...
            final GridViewAdapter gridViewAdapter=new   GridViewAdapter(mContext, mData, i, pageSize);
...
//                        }
                    ...
                    gridItemClickListener.click(pos, position, mData.get(position).getName(),view);
                }
            });
